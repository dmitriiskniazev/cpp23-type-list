...
Part of the [cpp](../../README.md) monorepo — compile-time type lists for C++23 modules: a `nil` / `cons` spine, one module partition per operation, and a single umbrella import.
...
Or run the full check suite: `./scripts/ci.sh`

Generate `compile_commands.json` for clangd (from repo root):
...
```bash
./build/libs/type-list/type_list_front_example
./build/libs/type-list/type_list_map_example
```
...
Monorepo root: [../../README.md](../../README.md) · shared toolchain: `cmake/CppModules.cmake`
